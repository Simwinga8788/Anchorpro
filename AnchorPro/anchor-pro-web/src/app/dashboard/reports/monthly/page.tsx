    ...
    <div style={{ padding: '24px', maxWidth: '1200px', margin: '0 auto' }}>
      ...
      <div className="card" style={{ padding: '36px', background: 'var(--bg-card)', border: '1px solid var(--border-subtle)', borderRadius: 12 }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', borderBottom: '2px solid var(--border-subtle)', paddingBottom: 20, marginBottom: 24 }}>
          <div>
            <div style={{ fontSize: 22, fontWeight: 700, color: 'var(--text-primary)' }}>MONTHLY PROGRESS REPORT — AUGUST 2026</div>
            ...
            <div style={{ fontSize: 13, color: 'var(--text-secondary)', marginTop: 2 }}>Contract Standard: JBCC Edition 6.2 (State & Private)</div>
          </div>
          <div style={{ textAlign: 'right' }}>
            <div style={{ fontSize: 12, color: 'var(--text-secondary)', textTransform: 'uppercase' }}>Issued To</div>
            <div style={{ fontSize: 15, fontWeight: 700, color: 'var(--text-primary)' }}>Bicon Structural Consultants</div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 16, marginBottom: 28 }}>
          <div style={{ padding: 16, background: 'var(--bg-hover)', borderRadius: 8, border: '1px solid rgba(255,255,255,0.06)' }}>
            ...
            <div style={{ fontSize: 24, fontWeight: 700, color: 'var(--text-primary)', marginTop: 4 }}>$58,575.00</div>
          ...
          <div style={{ padding: 16, background: 'var(--bg-hover)', borderRadius: 8, border: '1px solid rgba(255,255,255,0.06)' }}>
            <div style={{ fontSize: 12, color: 'var(--text-secondary)', textTransform: 'uppercase' }}>Net Certified Payable (IPC-01)</div>
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 13.5 }}>
              ...
              <tbody>
                <tr style={{ borderBottom: '1px solid var(--border-subtle)' }}>
                  ...
                  <td style={{ padding: '10px', color: 'var(--text-primary)' }}>Preliminaries & General</td>
                ...
                <tr style={{ borderBottom: '1px solid var(--border-subtle)' }}>
                  ...
                  <td style={{ padding: '10px', color: 'var(--text-primary)' }}>Earthworks & Site Clearance</td>
                ...
                <tr style={{ borderBottom: '1px solid var(--border-subtle)' }}>
                  ...
                  <td style={{ padding: '10px', color: 'var(--text-primary)' }}>Concrete, Formwork & Rebar</td>
