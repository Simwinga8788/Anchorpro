...
export const financialApi = {
  ...
  createFromProduction: (contractId: number, shiftLogIds: number[]) => apiPost<any>(`/api/financial/invoices/from-production`, { contractId, shiftLogIds }),
...
export const shiftLogsApi = {
  ...
  getUnbilled:     ()                          => apiFetch<any[]>('/api/shift-logs/unbilled'),
  getSummary:      (from: string, to: string) => apiFetch<any>(`/api/shift-logs/summary?from=${from}&to=${to}`),
  getChartData:    (days: number)             => apiFetch<any[]>(`/api/shift-logs/chart-data?days=${days}`),
...
export const quotationsApi = {
  ...
  createAdHoc:   (data: any)           => apiPost<any>('/api/quotations', data),
...
export const scheduleApi = {
  ...
  create: (data: { projectId: number; title: string; trade?: string; plannedStartDate: string; plannedEndDate: string; predecessorMilestoneId?: number | null; boqSectionId?: number | null }) =>
    apiPost<any>('/api/schedule', data),
  update: (id: number, data: { title: string; trade?: string; plannedStartDate: string; plannedEndDate: string; predecessorMilestoneId?: number | null; boqSectionId?: number | null }) =>
