        ...
        private async Task<List<string>> GetUserAllowedRoutesAsync(int? tenantId, List<string> roles)
        {
            ...
            foreach (var role in roles)
            {
                ...
                else
                {
                    ...
                    {
                        "Admin" => new List<string> { "/dashboard", "/dashboard/boq", "/dashboard/site-diary", "/dashboard/certificates", "/dashboard/variations", "/dashboard/schedule", "/dashboard/performance", "/dashboard/intelligence", "/dashboard/finance", "/dashboard/jobs", "/dashboard/planning", "/dashboard/time-tracking", "/dashboard/assets", "/dashboard/inventory", "/dashboard/procurement", "/dashboard/team", "/dashboard/hr", "/dashboard/reports", "/dashboard/safety", "/dashboard/contracts", "/dashboard/roles", "/dashboard/settings", "/dashboard/customers", "/dashboard/tools", "/dashboard/my-tools", "/dashboard/downtime", "/dashboard/invoices", "/dashboard/my-jobs", "/dashboard/shift-logs", "/dashboard/shift-planning", "/dashboard/contractors", "/dashboard/projects", "/dashboard/projects/my-tasks" },
                        "HR" => new List<string> { "/dashboard", "/dashboard/boq", "/dashboard/site-diary", "/dashboard/certificates", "/dashboard/intelligence", "/dashboard/finance", "/dashboard/jobs", "/dashboard/planning", "/dashboard/time-tracking", "/dashboard/assets", "/dashboard/inventory", "/dashboard/procurement", "/dashboard/team", "/dashboard/hr", "/dashboard/reports", "/dashboard/safety", "/dashboard/contracts", "/dashboard/customers", "/dashboard/my-tools", "/dashboard/downtime", "/dashboard/invoices", "/dashboard/my-jobs", "/dashboard/shift-logs", "/dashboard/shift-planning", "/dashboard/contractors", "/dashboard/projects", "/dashboard/projects/my-tasks" },
                        "Planner" => new List<string> { "/dashboard", "/dashboard/boq", "/dashboard/site-diary", "/dashboard/certificates", "/dashboard/variations", "/dashboard/schedule", "/dashboard/performance", "/dashboard/jobs", "/dashboard/planning", "/dashboard/time-tracking", "/dashboard/assets", "/dashboard/inventory", "/dashboard/procurement", "/dashboard/reports", "/dashboard/safety", "/dashboard/roles", "/dashboard/customers", "/dashboard/tools", "/dashboard/my-tools", "/dashboard/downtime", "/dashboard/my-jobs", "/dashboard/shift-logs", "/dashboard/shift-planning", "/dashboard/contractors", "/dashboard/projects", "/dashboard/projects/my-tasks" },
                        "Supervisor" => new List<string> { "/dashboard", "/dashboard/boq", "/dashboard/site-diary", "/dashboard/certificates", "/dashboard/variations", "/dashboard/performance", "/dashboard/jobs", "/dashboard/planning", "/dashboard/time-tracking", "/dashboard/assets", "/dashboard/inventory", "/dashboard/procurement", "/dashboard/reports", "/dashboard/safety", "/dashboard/roles", "/dashboard/customers", "/dashboard/tools", "/dashboard/my-tools", "/dashboard/downtime", "/dashboard/my-jobs", "/dashboard/shift-logs", "/dashboard/shift-planning", "/dashboard/contractors", "/dashboard/projects", "/dashboard/projects/my-tasks" },
                        "Technician" => new List<string> { "/dashboard/site-diary", "/dashboard/jobs", "/dashboard/procurement", "/dashboard/safety", "/dashboard/my-tools", "/dashboard/my-jobs" },
                        "Purchasing" => new List<string> { "/dashboard/procurement", "/dashboard/inventory" },
                        "Storeman" => new List<string> { "/dashboard/inventory", "/dashboard/procurement", "/dashboard/my-tools" },
                        "Finance" => new List<string> { "/dashboard/certificates", "/dashboard/finance", "/dashboard/invoices", "/dashboard/procurement" },
                        _ => new List<string>()
                    };
        ...
        public async Task<ActionResult> Register([FromBody] RegisterRequest req)
        {
            ...
            if (tenant.OperationMode == OperationMode.SiteDiary)
            {
                var dictSettings = new List<SystemSetting>
                {
                    ...
                    new SystemSetting { TenantId = tenant.Id, Key = "Dict.Unit", Value = "units", Group = "Dictionary" },
                    new SystemSetting { TenantId = tenant.Id, Key = "Dict.ShiftLogsTitle", Value = "Site Daily Logs", Group = "Dictionary" },
                    new SystemSetting { TenantId = tenant.Id, Key = "Dict.ShiftLogsSubtitle", Value = "Track daily site progress, labor, and target vs actual output.", Group = "Dictionary" },
                    new SystemSetting { TenantId = tenant.Id, Key = "Dict.ShiftLogItem", Value = "Daily Log", Group = "Dictionary" },
                    new SystemSetting { TenantId = tenant.Id, Key = "Dict.TodayProduction", Value = "Today's Progress", Group = "Dictionary" },
                    new SystemSetting { TenantId = tenant.Id, Key = "Dict.Activity0", Value = "General Construction", Group = "Dictionary" },
                    new SystemSetting { TenantId = tenant.Id, Key = "Dict.Activity1", Value = "Excavation & Earthworks", Group = "Dictionary" },
                    new SystemSetting { TenantId = tenant.Id, Key = "Dict.Activity2", Value = "Loading", Group = "Dictionary" },
                    new SystemSetting { TenantId = tenant.Id, Key = "Dict.Activity3", Value = "Haulage & Transport", Group = "Dictionary" },
                    new SystemSetting { TenantId = tenant.Id, Key = "Dict.Activity4", Value = "Foundation & Substructure", Group = "Dictionary" },
                    new SystemSetting { TenantId = tenant.Id, Key = "Dict.Activity5", Value = "Site Clearance", Group = "Dictionary" },
                    ...
                    new SystemSetting { TenantId = tenant.Id, Key = "Dict.MiningOperations", Value = "Site Operations", Group = "Dictionary" },
