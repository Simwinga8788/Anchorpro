...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260728092816_AddMiningContractorAndProjectFields') THEN
    ALTER TABLE "ShiftProductionLogs" ADD "ContractorContractId" integer;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260728092816_AddMiningContractorAndProjectFields') THEN
    ALTER TABLE "ShiftProductionLogs" ADD "MiningActivity" integer;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260728092816_AddMiningContractorAndProjectFields') THEN
    ALTER TABLE "Projects" ADD "ActualCost" numeric(18,2) NOT NULL DEFAULT 0.0;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260728092816_AddMiningContractorAndProjectFields') THEN
    ALTER TABLE "Projects" ADD "Colour" character varying(10);
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260728092816_AddMiningContractorAndProjectFields') THEN
    ALTER TABLE "Projects" ADD "CompletionPercentage" integer NOT NULL DEFAULT 0;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260728092816_AddMiningContractorAndProjectFields') THEN
    ALTER TABLE "Contracts" ADD "ContractPartyType" integer NOT NULL DEFAULT 0;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260728092816_AddMiningContractorAndProjectFields') THEN
    ALTER TABLE "Contracts" ADD "RateType" character varying(50);
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260728092816_AddMiningContractorAndProjectFields') THEN
    ALTER TABLE "Contracts" ADD "WorkingArea" character varying(200);
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260728092816_AddMiningContractorAndProjectFields') THEN
    CREATE INDEX "IX_ShiftProductionLogs_ContractorContractId" ON "ShiftProductionLogs" ("ContractorContractId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260728092816_AddMiningContractorAndProjectFields') THEN
    ALTER TABLE "ShiftProductionLogs" ADD CONSTRAINT "FK_ShiftProductionLogs_Contracts_ContractorContractId" FOREIGN KEY ("ContractorContractId") REFERENCES "Contracts" ("Id");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260728092816_AddMiningContractorAndProjectFields') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20260728092816_AddMiningContractorAndProjectFields', '8.0.11');
    END IF;
END $EF$;
COMMIT;
...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260728100246_AddShiftResourcesAndClientLink') THEN
    ALTER TABLE "ShiftProductionLogs" ADD "ClientContractId" integer;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260728100246_AddShiftResourcesAndClientLink') THEN
    ALTER TABLE "ShiftProductionLogs" ADD "Material" character varying(100);
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260728100246_AddShiftResourcesAndClientLink') THEN
    CREATE TABLE "ShiftResources" (
        "Id" integer GENERATED BY DEFAULT AS IDENTITY,
        "ShiftProductionLogId" integer NOT NULL,
        "EquipmentId" integer,
        "OperatorId" character varying(450),
        ...
        "UpdatedAt" timestamp without time zone,
        "UpdatedBy" character varying(85),
        CONSTRAINT "PK_ShiftResources" PRIMARY KEY ("Id"),
        CONSTRAINT "FK_ShiftResources_AspNetUsers_OperatorId" FOREIGN KEY ("OperatorId") REFERENCES "AspNetUsers" ("Id"),
        CONSTRAINT "FK_ShiftResources_Equipment_EquipmentId" FOREIGN KEY ("EquipmentId") REFERENCES "Equipment" ("Id"),
        CONSTRAINT "FK_ShiftResources_ShiftProductionLogs_ShiftProductionLogId" FOREIGN KEY ("ShiftProductionLogId") REFERENCES "ShiftProductionLogs" ("Id") ON DELETE CASCADE
    );
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260728100246_AddShiftResourcesAndClientLink') THEN
    CREATE INDEX "IX_ShiftProductionLogs_ClientContractId" ON "ShiftProductionLogs" ("ClientContractId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260728100246_AddShiftResourcesAndClientLink') THEN
    CREATE INDEX "IX_ShiftResources_EquipmentId" ON "ShiftResources" ("EquipmentId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260728100246_AddShiftResourcesAndClientLink') THEN
    CREATE INDEX "IX_ShiftResources_OperatorId" ON "ShiftResources" ("OperatorId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260728100246_AddShiftResourcesAndClientLink') THEN
    CREATE INDEX "IX_ShiftResources_ShiftProductionLogId" ON "ShiftResources" ("ShiftProductionLogId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260728100246_AddShiftResourcesAndClientLink') THEN
    ALTER TABLE "ShiftProductionLogs" ADD CONSTRAINT "FK_ShiftProductionLogs_Contracts_ClientContractId" FOREIGN KEY ("ClientContractId") REFERENCES "Contracts" ("Id");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260728100246_AddShiftResourcesAndClientLink') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20260728100246_AddShiftResourcesAndClientLink', '8.0.11');
    END IF;
END $EF$;
COMMIT;
...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260728101908_AddShiftPlanning') THEN
    CREATE TABLE "ShiftPlans" (
        "Id" integer GENERATED BY DEFAULT AS IDENTITY,
        "PlanDate" timestamp without time zone NOT NULL,
        "Shift" integer NOT NULL,
        "MineCaptainId" character varying(450),
        "ShiftBossId" character varying(450),
        "OverallTargetTonnage" numeric,
        "Notes" character varying(1000),
        "Status" integer NOT NULL,
        "TenantId" integer,
        "CreatedAt" timestamp without time zone NOT NULL,
        ...
        "UpdatedAt" timestamp without time zone,
        "UpdatedBy" character varying(85),
        CONSTRAINT "PK_ShiftPlans" PRIMARY KEY ("Id"),
        CONSTRAINT "FK_ShiftPlans_AspNetUsers_MineCaptainId" FOREIGN KEY ("MineCaptainId") REFERENCES "AspNetUsers" ("Id"),
        CONSTRAINT "FK_ShiftPlans_AspNetUsers_ShiftBossId" FOREIGN KEY ("ShiftBossId") REFERENCES "AspNetUsers" ("Id")
    );
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260728101908_AddShiftPlanning') THEN
    CREATE TABLE "ShiftPlanTasks" (
        "Id" integer GENERATED BY DEFAULT AS IDENTITY,
        "ShiftPlanId" integer NOT NULL,
        "ActivityCategory" character varying(100),
        "EquipmentId" integer,
        "OperatorId" character varying(450),
        "TargetPrimary" numeric,
        "TargetPrimaryUnit" character varying(50),
        "TargetTonnage" numeric,
        "Location" character varying(200),
        "DrillRingAndHole" character varying(100),
        "AssignedTrucks" character varying(500),
        ...
        "UpdatedAt" timestamp without time zone,
        "UpdatedBy" character varying(85),
        CONSTRAINT "PK_ShiftPlanTasks" PRIMARY KEY ("Id"),
        CONSTRAINT "FK_ShiftPlanTasks_AspNetUsers_OperatorId" FOREIGN KEY ("OperatorId") REFERENCES "AspNetUsers" ("Id"),
        CONSTRAINT "FK_ShiftPlanTasks_Equipment_EquipmentId" FOREIGN KEY ("EquipmentId") REFERENCES "Equipment" ("Id"),
        CONSTRAINT "FK_ShiftPlanTasks_ShiftPlans_ShiftPlanId" FOREIGN KEY ("ShiftPlanId") REFERENCES "ShiftPlans" ("Id") ON DELETE CASCADE
    );
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260728101908_AddShiftPlanning') THEN
    CREATE INDEX "IX_ShiftPlans_MineCaptainId" ON "ShiftPlans" ("MineCaptainId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260728101908_AddShiftPlanning') THEN
    CREATE INDEX "IX_ShiftPlans_ShiftBossId" ON "ShiftPlans" ("ShiftBossId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260728101908_AddShiftPlanning') THEN
    CREATE INDEX "IX_ShiftPlanTasks_EquipmentId" ON "ShiftPlanTasks" ("EquipmentId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260728101908_AddShiftPlanning') THEN
    CREATE INDEX "IX_ShiftPlanTasks_OperatorId" ON "ShiftPlanTasks" ("OperatorId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260728101908_AddShiftPlanning') THEN
    CREATE INDEX "IX_ShiftPlanTasks_ShiftPlanId" ON "ShiftPlanTasks" ("ShiftPlanId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260728101908_AddShiftPlanning') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20260728101908_AddShiftPlanning', '8.0.11');
    END IF;
END $EF$;
COMMIT;
...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260728105146_AddShiftResourceDowntime') THEN
    ALTER TABLE "ShiftResources" ADD "DowntimeHours" numeric;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260728105146_AddShiftResourceDowntime') THEN
    ALTER TABLE "ShiftResources" ADD "DowntimeReason" character varying(200);
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260728105146_AddShiftResourceDowntime') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20260728105146_AddShiftResourceDowntime', '8.0.11');
    END IF;
END $EF$;
COMMIT;
...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260728110231_AddShiftResourceMetrics') THEN
    ALTER TABLE "ShiftResources" ADD "ActualQuantity" numeric;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260728110231_AddShiftResourceMetrics') THEN
    ALTER TABLE "ShiftResources" ADD "QuantityUnit" character varying(50);
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260728110231_AddShiftResourceMetrics') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20260728110231_AddShiftResourceMetrics', '8.0.11');
    END IF;
END $EF$;
COMMIT;
...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260728234031_RenameMiningFieldsToGeneric') THEN
    ALTER TABLE "ShiftProductionLogs" RENAME COLUMN "MiningActivity" TO "OperationActivity";
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260728234031_RenameMiningFieldsToGeneric') THEN
    ALTER TABLE "ShiftPlanTasks" RENAME COLUMN "TargetTonnage" TO "TargetSecondary";
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260728234031_RenameMiningFieldsToGeneric') THEN
    ALTER TABLE "ShiftPlanTasks" RENAME COLUMN "DrillRingAndHole" TO "ReferenceCode";
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260728234031_RenameMiningFieldsToGeneric') THEN
    ALTER TABLE "ShiftPlans" RENAME COLUMN "OverallTargetTonnage" TO "OverallTargetSecondary";
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260728234031_RenameMiningFieldsToGeneric') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20260728234031_RenameMiningFieldsToGeneric', '8.0.11');
    END IF;
END $EF$;
COMMIT;
...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260729113401_LinkShiftLogToShiftPlan') THEN
    ALTER TABLE "ShiftResources" ADD "PlannedQuantity" numeric;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260729113401_LinkShiftLogToShiftPlan') THEN
    ALTER TABLE "ShiftProductionLogs" ADD "ShiftPlanId" integer;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260729113401_LinkShiftLogToShiftPlan') THEN
    CREATE INDEX "IX_ShiftProductionLogs_ShiftPlanId" ON "ShiftProductionLogs" ("ShiftPlanId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260729113401_LinkShiftLogToShiftPlan') THEN
    ALTER TABLE "ShiftProductionLogs" ADD CONSTRAINT "FK_ShiftProductionLogs_ShiftPlans_ShiftPlanId" FOREIGN KEY ("ShiftPlanId") REFERENCES "ShiftPlans" ("Id");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260729113401_LinkShiftLogToShiftPlan') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20260729113401_LinkShiftLogToShiftPlan', '8.0.11');
    END IF;
END $EF$;
COMMIT;
...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260729232725_AddShiftPlanIdAndPlannedQuantity') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20260729232725_AddShiftPlanIdAndPlannedQuantity', '8.0.11');
    END IF;
END $EF$;
COMMIT;
...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260729234240_AddShiftPlanLinkToLogs') THEN
    ALTER TABLE "ShiftPlanTasks" ADD "ActualQuantity" numeric;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260729234240_AddShiftPlanLinkToLogs') THEN
    ALTER TABLE "ShiftPlanTasks" ADD "CompletedAt" timestamp without time zone;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260729234240_AddShiftPlanLinkToLogs') THEN
    ALTER TABLE "ShiftPlanTasks" ADD "CompletedByName" character varying(200);
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260729234240_AddShiftPlanLinkToLogs') THEN
    ALTER TABLE "ShiftPlanTasks" ADD "CompletedByUserId" character varying(450);
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260729234240_AddShiftPlanLinkToLogs') THEN
    ALTER TABLE "ShiftPlanTasks" ADD "CompletionNotes" character varying(1000);
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260729234240_AddShiftPlanLinkToLogs') THEN
    ALTER TABLE "ShiftPlanTasks" ADD "IsCompleted" boolean NOT NULL DEFAULT FALSE;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260729234240_AddShiftPlanLinkToLogs') THEN
    ALTER TABLE "ShiftPlanTasks" ADD "PhotoUrl" character varying(1000);
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260729234240_AddShiftPlanLinkToLogs') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20260729234240_AddShiftPlanLinkToLogs', '8.0.11');
    END IF;
END $EF$;
COMMIT;
...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260729235001_AddPlannedQuantityAndShiftPlanId') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20260729235001_AddPlannedQuantityAndShiftPlanId', '8.0.11');
    END IF;
END $EF$;
COMMIT;
...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260729235054_LinkShiftPlanToLog_And_AddPlannedQuantity') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20260729235054_LinkShiftPlanToLog_And_AddPlannedQuantity', '8.0.11');
    END IF;
END $EF$;
COMMIT;
...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260729235325_AddShiftPlanLinkToLog') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20260729235325_AddShiftPlanLinkToLog', '8.0.11');
    END IF;
END $EF$;
COMMIT;
...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260730000405_LinkPlanToLog_PlannedQuantity') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20260730000405_LinkPlanToLog_PlannedQuantity', '8.0.11');
    END IF;
END $EF$;
COMMIT;
...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260730000500_AddShiftPlanLinkToSiteLog') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20260730000500_AddShiftPlanLinkToSiteLog', '8.0.11');
    END IF;
END $EF$;
COMMIT;
...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260814001016_LinkShiftPlansToProjects') THEN
    ALTER TABLE "ShiftPlanTasks" ADD "ProjectTaskId" integer;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260814001016_LinkShiftPlansToProjects') THEN
    ALTER TABLE "ShiftPlans" ADD "ProjectId" integer;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260814001016_LinkShiftPlansToProjects') THEN
    CREATE INDEX "IX_ShiftPlanTasks_ProjectTaskId" ON "ShiftPlanTasks" ("ProjectTaskId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260814001016_LinkShiftPlansToProjects') THEN
    CREATE INDEX "IX_ShiftPlans_ProjectId" ON "ShiftPlans" ("ProjectId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260814001016_LinkShiftPlansToProjects') THEN
    ALTER TABLE "ShiftPlans" ADD CONSTRAINT "FK_ShiftPlans_Projects_ProjectId" FOREIGN KEY ("ProjectId") REFERENCES "Projects" ("Id");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260814001016_LinkShiftPlansToProjects') THEN
    ALTER TABLE "ShiftPlanTasks" ADD CONSTRAINT "FK_ShiftPlanTasks_ProjectTasks_ProjectTaskId" FOREIGN KEY ("ProjectTaskId") REFERENCES "ProjectTasks" ("Id");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260814001016_LinkShiftPlansToProjects') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20260814001016_LinkShiftPlansToProjects', '8.0.11');
    END IF;
END $EF$;
COMMIT;
...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260814002152_LinkJobCardsToShiftPlanTasks') THEN
    ALTER TABLE "JobCards" ADD "ShiftPlanTaskId" integer;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260814002152_LinkJobCardsToShiftPlanTasks') THEN
    CREATE INDEX "IX_JobCards_ShiftPlanTaskId" ON "JobCards" ("ShiftPlanTaskId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260814002152_LinkJobCardsToShiftPlanTasks') THEN
    ALTER TABLE "JobCards" ADD CONSTRAINT "FK_JobCards_ShiftPlanTasks_ShiftPlanTaskId" FOREIGN KEY ("ShiftPlanTaskId") REFERENCES "ShiftPlanTasks" ("Id");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260814002152_LinkJobCardsToShiftPlanTasks') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20260814002152_LinkJobCardsToShiftPlanTasks', '8.0.11');
    END IF;
END $EF$;
COMMIT;
...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260816120536_MakeJobCardEquipmentOptional') THEN
    ALTER TABLE "JobCards" DROP CONSTRAINT "FK_JobCards_Equipment_EquipmentId";
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260816120536_MakeJobCardEquipmentOptional') THEN
    ALTER TABLE "JobCards" ALTER COLUMN "EquipmentId" DROP NOT NULL;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260816120536_MakeJobCardEquipmentOptional') THEN
    ALTER TABLE "JobCards" ADD CONSTRAINT "FK_JobCards_Equipment_EquipmentId" FOREIGN KEY ("EquipmentId") REFERENCES "Equipment" ("Id");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260816120536_MakeJobCardEquipmentOptional') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20260816120536_MakeJobCardEquipmentOptional', '8.0.11');
    END IF;
END $EF$;
COMMIT;
...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260825234334_AddConstructionCoreTables') THEN
    CREATE TABLE "BillsOfQuantities" (
        "Id" integer GENERATED BY DEFAULT AS IDENTITY,
        "ProjectId" integer NOT NULL,
        "Title" character varying(150) NOT NULL,
        "VersionNumber" integer NOT NULL,
        "Status" integer NOT NULL,
        "TotalContractSum" numeric(18,2) NOT NULL,
        "Notes" text,
        "ApprovedAt" timestamp without time zone,
        "ApprovedById" character varying(85),
        "TenantId" integer,
        ...
        "UpdatedAt" timestamp without time zone,
        "UpdatedBy" character varying(85),
        CONSTRAINT "PK_BillsOfQuantities" PRIMARY KEY ("Id"),
        CONSTRAINT "FK_BillsOfQuantities_AspNetUsers_ApprovedById" FOREIGN KEY ("ApprovedById") REFERENCES "AspNetUsers" ("Id"),
        CONSTRAINT "FK_BillsOfQuantities_Projects_ProjectId" FOREIGN KEY ("ProjectId") REFERENCES "Projects" ("Id") ON DELETE CASCADE
    );
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260825234334_AddConstructionCoreTables') THEN
    CREATE TABLE "SiteDiaryEntries" (
        "Id" integer GENERATED BY DEFAULT AS IDENTITY,
        "ProjectId" integer NOT NULL,
        "DiaryDate" timestamp without time zone NOT NULL,
        "WeatherCondition" character varying(100) NOT NULL,
        "TemperatureCelsius" numeric,
        "WorkPerformedSummary" text NOT NULL,
        "SiteInstructionsReceived" text,
        "DelaysOrConstraints" text,
        "Status" integer NOT NULL,
        "LoggedById" character varying(85),
        "ApprovedAt" timestamp without time zone,
        "ApprovedById" character varying(85),
        "TenantId" integer,
        "CreatedAt" timestamp without time zone NOT NULL,
        ...
        "UpdatedAt" timestamp without time zone,
        "UpdatedBy" character varying(85),
        CONSTRAINT "PK_SiteDiaryEntries" PRIMARY KEY ("Id"),
        CONSTRAINT "FK_SiteDiaryEntries_AspNetUsers_ApprovedById" FOREIGN KEY ("ApprovedById") REFERENCES "AspNetUsers" ("Id"),
        CONSTRAINT "FK_SiteDiaryEntries_AspNetUsers_LoggedById" FOREIGN KEY ("LoggedById") REFERENCES "AspNetUsers" ("Id"),
        CONSTRAINT "FK_SiteDiaryEntries_Projects_ProjectId" FOREIGN KEY ("ProjectId") REFERENCES "Projects" ("Id") ON DELETE CASCADE
    );
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260825234334_AddConstructionCoreTables') THEN
    CREATE TABLE "BoqSections" (
        "Id" integer GENERATED BY DEFAULT AS IDENTITY,
        "BillOfQuantitiesId" integer NOT NULL,
        "SectionCode" character varying(30) NOT NULL,
        "SectionName" character varying(200) NOT NULL,
        "Subtotal" numeric(18,2) NOT NULL,
        ...
        "UpdatedAt" timestamp without time zone,
        "UpdatedBy" character varying(85),
        CONSTRAINT "PK_BoqSections" PRIMARY KEY ("Id"),
        CONSTRAINT "FK_BoqSections_BillsOfQuantities_BillOfQuantitiesId" FOREIGN KEY ("BillOfQuantitiesId") REFERENCES "BillsOfQuantities" ("Id") ON DELETE CASCADE
    );
    END IF;
END $EF$;
...
BEGIN
    ...
    CREATE TABLE "PaymentCertificates" (
        ...
        "Status" integer NOT NULL,
        "GrossValuationToDate" numeric(18,2) NOT NULL,
        "RetentionPercentage" numeric(5,2) NOT NULL,
        "RetentionDeductionToDate" numeric(18,2) NOT NULL,
        "PreviousCertificatesPaid" numeric(18,2) NOT NULL,
        "NetAmountDue" numeric(18,2) NOT NULL,
        "ConsultantName" character varying(150),
        ...
        CONSTRAINT "FK_PaymentCertificates_AspNetUsers_ApprovedById" FOREIGN KEY ("ApprovedById") REFERENCES "AspNetUsers" ("Id"),
        CONSTRAINT "FK_PaymentCertificates_BillsOfQuantities_BillOfQuantitiesId" FOREIGN KEY ("BillOfQuantitiesId") REFERENCES "BillsOfQuantities" ("Id"),
        CONSTRAINT "FK_PaymentCertificates_Projects_ProjectId" FOREIGN KEY ("ProjectId") REFERENCES "Projects" ("Id") ON DELETE CASCADE
    );
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260825234334_AddConstructionCoreTables') THEN
    CREATE TABLE "SiteDiaryDeliveries" (
        "Id" integer GENERATED BY DEFAULT AS IDENTITY,
        "SiteDiaryEntryId" integer NOT NULL,
        "SupplierName" character varying(150) NOT NULL,
        "MaterialDescription" character varying(200) NOT NULL,
        "QuantityReceived" numeric(18,2) NOT NULL,
        "UnitOfMeasure" character varying(30) NOT NULL,
        "DeliveryNoteNumber" character varying(80),
        ...
        "UpdatedAt" timestamp without time zone,
        "UpdatedBy" character varying(85),
        CONSTRAINT "PK_SiteDiaryDeliveries" PRIMARY KEY ("Id"),
        CONSTRAINT "FK_SiteDiaryDeliveries_SiteDiaryEntries_SiteDiaryEntryId" FOREIGN KEY ("SiteDiaryEntryId") REFERENCES "SiteDiaryEntries" ("Id") ON DELETE CASCADE
    );
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260825234334_AddConstructionCoreTables') THEN
    CREATE TABLE "SiteDiaryLabours" (
        "Id" integer GENERATED BY DEFAULT AS IDENTITY,
        "SiteDiaryEntryId" integer NOT NULL,
        "TradeOrCrewName" character varying(100) NOT NULL,
        ...
        "UpdatedAt" timestamp without time zone,
        "UpdatedBy" character varying(85),
        CONSTRAINT "PK_SiteDiaryLabours" PRIMARY KEY ("Id"),
        CONSTRAINT "FK_SiteDiaryLabours_SiteDiaryEntries_SiteDiaryEntryId" FOREIGN KEY ("SiteDiaryEntryId") REFERENCES "SiteDiaryEntries" ("Id") ON DELETE CASCADE
    );
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260825234334_AddConstructionCoreTables') THEN
    CREATE TABLE "SiteDiaryPhotos" (
        "Id" integer GENERATED BY DEFAULT AS IDENTITY,
        "SiteDiaryEntryId" integer NOT NULL,
        "PhotoUrl" text NOT NULL,
        "Caption" character varying(255),
        "TakenAt" timestamp without time zone NOT NULL,
        "UploadedById" character varying(85),
        "TenantId" integer,
        "CreatedAt" timestamp without time zone NOT NULL,
        "CreatedBy" character varying(85),
        "UpdatedAt" timestamp without time zone,
        "UpdatedBy" character varying(85),
        CONSTRAINT "PK_SiteDiaryPhotos" PRIMARY KEY ("Id"),
        CONSTRAINT "FK_SiteDiaryPhotos_AspNetUsers_UploadedById" FOREIGN KEY ("UploadedById") REFERENCES "AspNetUsers" ("Id"),
        CONSTRAINT "FK_SiteDiaryPhotos_SiteDiaryEntries_SiteDiaryEntryId" FOREIGN KEY ("SiteDiaryEntryId") REFERENCES "SiteDiaryEntries" ("Id") ON DELETE CASCADE
    );
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260825234334_AddConstructionCoreTables') THEN
    CREATE TABLE "SiteDiaryPlants" (
        "Id" integer GENERATED BY DEFAULT AS IDENTITY,
        "SiteDiaryEntryId" integer NOT NULL,
        "EquipmentId" integer,
        "EquipmentName" character varying(150) NOT NULL,
        "OperatingHours" numeric(8,2) NOT NULL,
        "IdleHours" numeric(8,2) NOT NULL,
        "BreakdownHours" numeric(8,2) NOT NULL,
        "FuelConsumedLitres" numeric(8,2),
        "Notes" text,
        "TenantId" integer,
        "CreatedAt" timestamp without time zone NOT NULL,
        "CreatedBy" character varying(85),
        "UpdatedAt" timestamp without time zone,
        "UpdatedBy" character varying(85),
        CONSTRAINT "PK_SiteDiaryPlants" PRIMARY KEY ("Id"),
        CONSTRAINT "FK_SiteDiaryPlants_Equipment_EquipmentId" FOREIGN KEY ("EquipmentId") REFERENCES "Equipment" ("Id"),
        CONSTRAINT "FK_SiteDiaryPlants_SiteDiaryEntries_SiteDiaryEntryId" FOREIGN KEY ("SiteDiaryEntryId") REFERENCES "SiteDiaryEntries" ("Id") ON DELETE CASCADE
    );
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260825234334_AddConstructionCoreTables') THEN
    CREATE TABLE "SiteDiarySafeties" (
        "Id" integer GENERATED BY DEFAULT AS IDENTITY,
        "SiteDiaryEntryId" integer NOT NULL,
        "ToolboxTalkTopic" character varying(200),
        "IncidentsReported" integer NOT NULL,
        "NearMissesCount" integer NOT NULL,
        ...
        "UpdatedAt" timestamp without time zone,
        "UpdatedBy" character varying(85),
        CONSTRAINT "PK_SiteDiarySafeties" PRIMARY KEY ("Id"),
        CONSTRAINT "FK_SiteDiarySafeties_SiteDiaryEntries_SiteDiaryEntryId" FOREIGN KEY ("SiteDiaryEntryId") REFERENCES "SiteDiaryEntries" ("Id") ON DELETE CASCADE
    );
    END IF;
END $EF$;
...
BEGIN
    ...
    CREATE TABLE "BoqItems" (
        ...
        "UpdatedAt" timestamp without time zone,
        "UpdatedBy" character varying(85),
        CONSTRAINT "PK_BoqItems" PRIMARY KEY ("Id"),
        CONSTRAINT "FK_BoqItems_BoqSections_BoqSectionId" FOREIGN KEY ("BoqSectionId") REFERENCES "BoqSections" ("Id") ON DELETE CASCADE
    );
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260825234334_AddConstructionCoreTables') THEN
    CREATE TABLE "PaymentCertificateItems" (
        "Id" integer GENERATED BY DEFAULT AS IDENTITY,
        "PaymentCertificateId" integer NOT NULL,
        "BoqItemId" integer NOT NULL,
        "PreviousQuantity" numeric(18,3) NOT NULL,
        "CurrentQuantityCompleted" numeric(18,3) NOT NULL,
        "CumulativeQuantityCompleted" numeric(18,3) NOT NULL,
        "CumulativeValueCompleted" numeric(18,2) NOT NULL,
        "PercentageComplete" numeric(5,2) NOT NULL,
        "Notes" text,
        "TenantId" integer,
        "CreatedAt" timestamp without time zone NOT NULL,
        "CreatedBy" character varying(85),
        "UpdatedAt" timestamp without time zone,
        "UpdatedBy" character varying(85),
        CONSTRAINT "PK_PaymentCertificateItems" PRIMARY KEY ("Id"),
        CONSTRAINT "FK_PaymentCertificateItems_BoqItems_BoqItemId" FOREIGN KEY ("BoqItemId") REFERENCES "BoqItems" ("Id") ON DELETE CASCADE,
        CONSTRAINT "FK_PaymentCertificateItems_PaymentCertificates_PaymentCertific~" FOREIGN KEY ("PaymentCertificateId") REFERENCES "PaymentCertificates" ("Id") ON DELETE CASCADE
    );
    END IF;
END $EF$;
...
BEGIN
    ...
    CREATE TABLE "Variations" (
        "Id" integer GENERATED BY DEFAULT AS IDENTITY,
        "ProjectId" integer NOT NULL,
        "VariationNumber" character varying(50) NOT NULL,
        "Title" character varying(200) NOT NULL,
        "Description" text NOT NULL,
        "Reason" text,
        "Status" integer NOT NULL,
        ...
        CONSTRAINT "FK_Variations_AspNetUsers_ApprovedById" FOREIGN KEY ("ApprovedById") REFERENCES "AspNetUsers" ("Id"),
        CONSTRAINT "FK_Variations_BoqItems_BoqItemId" FOREIGN KEY ("BoqItemId") REFERENCES "BoqItems" ("Id"),
        CONSTRAINT "FK_Variations_Projects_ProjectId" FOREIGN KEY ("ProjectId") REFERENCES "Projects" ("Id") ON DELETE CASCADE
    );
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260825234334_AddConstructionCoreTables') THEN
    CREATE INDEX "IX_BillsOfQuantities_ApprovedById" ON "BillsOfQuantities" ("ApprovedById");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260825234334_AddConstructionCoreTables') THEN
    CREATE INDEX "IX_BillsOfQuantities_ProjectId" ON "BillsOfQuantities" ("ProjectId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260825234334_AddConstructionCoreTables') THEN
    CREATE INDEX "IX_BoqItems_BoqSectionId" ON "BoqItems" ("BoqSectionId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260825234334_AddConstructionCoreTables') THEN
    CREATE INDEX "IX_BoqSections_BillOfQuantitiesId" ON "BoqSections" ("BillOfQuantitiesId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260825234334_AddConstructionCoreTables') THEN
    CREATE INDEX "IX_PaymentCertificateItems_BoqItemId" ON "PaymentCertificateItems" ("BoqItemId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260825234334_AddConstructionCoreTables') THEN
    CREATE INDEX "IX_PaymentCertificateItems_PaymentCertificateId" ON "PaymentCertificateItems" ("PaymentCertificateId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260825234334_AddConstructionCoreTables') THEN
    CREATE INDEX "IX_PaymentCertificates_ApprovedById" ON "PaymentCertificates" ("ApprovedById");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260825234334_AddConstructionCoreTables') THEN
    CREATE INDEX "IX_PaymentCertificates_BillOfQuantitiesId" ON "PaymentCertificates" ("BillOfQuantitiesId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260825234334_AddConstructionCoreTables') THEN
    CREATE INDEX "IX_SiteDiaryDeliveries_SiteDiaryEntryId" ON "SiteDiaryDeliveries" ("SiteDiaryEntryId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260825234334_AddConstructionCoreTables') THEN
    CREATE INDEX "IX_SiteDiaryEntries_ApprovedById" ON "SiteDiaryEntries" ("ApprovedById");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260825234334_AddConstructionCoreTables') THEN
    CREATE INDEX "IX_SiteDiaryEntries_LoggedById" ON "SiteDiaryEntries" ("LoggedById");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260825234334_AddConstructionCoreTables') THEN
    CREATE INDEX "IX_SiteDiaryEntries_ProjectId" ON "SiteDiaryEntries" ("ProjectId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260825234334_AddConstructionCoreTables') THEN
    CREATE INDEX "IX_SiteDiaryLabours_SiteDiaryEntryId" ON "SiteDiaryLabours" ("SiteDiaryEntryId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260825234334_AddConstructionCoreTables') THEN
    CREATE INDEX "IX_SiteDiaryPhotos_SiteDiaryEntryId" ON "SiteDiaryPhotos" ("SiteDiaryEntryId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260825234334_AddConstructionCoreTables') THEN
    CREATE INDEX "IX_SiteDiaryPhotos_UploadedById" ON "SiteDiaryPhotos" ("UploadedById");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260825234334_AddConstructionCoreTables') THEN
    CREATE INDEX "IX_SiteDiaryPlants_EquipmentId" ON "SiteDiaryPlants" ("EquipmentId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260825234334_AddConstructionCoreTables') THEN
    CREATE INDEX "IX_SiteDiaryPlants_SiteDiaryEntryId" ON "SiteDiaryPlants" ("SiteDiaryEntryId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260825234334_AddConstructionCoreTables') THEN
    CREATE INDEX "IX_SiteDiarySafeties_SiteDiaryEntryId" ON "SiteDiarySafeties" ("SiteDiaryEntryId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260825234334_AddConstructionCoreTables') THEN
    CREATE INDEX "IX_Variations_ApprovedById" ON "Variations" ("ApprovedById");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260825234334_AddConstructionCoreTables') THEN
    CREATE INDEX "IX_Variations_BoqItemId" ON "Variations" ("BoqItemId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260825234334_AddConstructionCoreTables') THEN
    CREATE INDEX "IX_Variations_ProjectId" ON "Variations" ("ProjectId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260825234334_AddConstructionCoreTables') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20260825234334_AddConstructionCoreTables', '8.0.11');
    END IF;
END $EF$;
COMMIT;
